...
if os.path.exists('data/education.db'):
    os.remove('data/education.db')
...
#insert data into table colleges
c.execute("""INSERT INTO `colleges` VALUES (1,'MIT',11,'Cambridge','MA','USA'),
...
c.execute("""INSERT INTO `students` VALUES (1,1,'Nancy','Davolio','1948-12-08','nancy@gmail.com','Seattle','WA','USA'),
